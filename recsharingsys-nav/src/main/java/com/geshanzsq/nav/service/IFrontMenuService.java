...
public interface IFrontMenuService {
     ...
     * 更新前台导航
     */
    void updateFrontNavRedis(String userId);

    List<FrontSiteVO> recommend();

    List<FrontSiteVO> recommendSites(String userId);
    /**
     * 查询站点
     * @param siteName
     * @return
     ...
     * 获取系统导航菜单
     */
    List<FrontMenuVO> getSystemNavMenu(String userId);
